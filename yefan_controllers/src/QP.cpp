...
int do_main() {
    ...
    const double torque_limits[] = {3000, 1000, 1000, 940, 940, 490};
    ...
    //model.remove(model.getConstrs()[0:6])
    ...
    path = ros::package::getPath("yefan_controllers");
    ...
    /// Logging
    path = ros::package::getPath("yefan_gazebo");
